...
Video 2 & 48.0 & 7.02429000 & 4.78110200 & -4.86297000 & 2.94725500 & -81.70470000 & 0.036 \\
...
\subsection{Collision at an Incident Angle of 37.6$^\circ$}
...
$$ \text{COR} = -\frac{v_{y2}}{v_{y1}} = -\frac{2.947255}{-4.86297} = 0.60606069953 \approx 0.606 $$
...
$$ \text{COF} = \frac{7.02429 - 4.781102}{2.947255 - (-4.86297)} = 0.28721170005 \approx 0.287 $$
...
\noindent The linear velocity at the contact point induced by rotation is:
$$ R|\omega_2| = (0.036)(81.7047) = 2.9413692 \approx 2.941 \text{ m/s} $$

\vspace{1em}
$$ S_2 = \frac{R|\omega_2|}{v_{x2}} = \frac{2.9413692}{4.781102} = 0.61520737269 \approx 0.615 $$

\vspace{1em}
\noindent Since $S_2 < 1$, the rightward translational velocity of the center of mass is greater than the leftward linear velocity at the contact point induced by rotation.

$$ e_x = \frac{2.9413692 - 4.781102}{7.02429} = -0.26191014323 \approx -0.262 $$

\subsection{Experiment result}
\begin{table}[h!]
\centering
\caption{Summary of calculated collision parameters for different incident angles.}
\label{tab:experiment_results_summary}
\begin{tabular}{lcccc}
\toprule
\textbf{Angle ($^\circ$)} & \textbf{COR} & \textbf{COF} & \textbf{$S_2$} & \textbf{$e_x$} \\
\midrule
34.2 & 0.642 & 0.374 & 0.723 & -0.168 \\
37.6 & 0.510 & 0.302 & 0.617 & -0.223 \\
48.0 & 0.606 & 0.287 & 0.615 & -0.262 \\
\bottomrule
\end{tabular}
\end{table}

\noindent The experimental results obtained at incident angles of $34.2^\circ$, $37.6^\circ$, and $48.0^\circ$ showed COR values of 0.642, 0.510, and 0.606, respectively, indicating no clear monotonic dependence on the incident angle. In contrast, the effective coefficient of friction decreased from 0.374 to 0.302 and then to 0.287 as the incident angle increased. The rebound spin parameter $S_2$ was calculated as 0.723, 0.617, and 0.615, while the corresponding tangential coefficients of restitution $e_x$ were $-0.168$, $-0.223$, and $-0.262$.

\vspace{1em}
\noindent Since $S_2 < 1$ and $e_x < 0$ in all three cases, the translational motion remained dominant after impact, and clear overspin or reverse sliding was not quantitatively observed. The difference from the theoretical prediction may be attributed to the greater hardness and lower deformability of the rubber disk used in the experiment, as well as uncertainties caused by manual launching and video tracking.
